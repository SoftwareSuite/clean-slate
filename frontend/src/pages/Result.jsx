    ...
    <div className="mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]">
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        { resultImage && <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
          ...
          <a className="px-8 py-2.5 text-white bg-gradient-to-r from-violet-600 to-fuchsia-500 rounded-full 
          hover:scale-105 transition-all duration-700" href={resultImage} download >Download image</a>
        </div>}
